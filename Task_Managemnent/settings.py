"""
Django settings for Task_Managemnent project.
...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://task-management-mstv.onrender.com','https://*.127.0.0.1']
...
ROOT_URLCONF = 'Task_Managemnent.urls'
...
WSGI_APPLICATION = 'Task_Managemnent.wsgi.application'
